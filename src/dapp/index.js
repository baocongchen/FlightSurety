    ...
    let contract = new Contract('localhost', () => {
        ...
        DOM.elid('register-airline').addEventListener('click', () => {
            ...
            contract.registerAirline(airline, from, (error, result) => {
                console.log(error, result);
                display('Airlines', 'Register airlines', [{ label: 'Register Airline', error: error, value: result}]);
            });
        });
        ...
        DOM.elid('fetch-registration-status').addEventListener('click', () => {
            ...
            contract.isAirlineRegistered(airline, (error, result) => {
                console.log(error, result);
                display('Airlines', 'Get Status Code', [ { label: 'Registration Status', error: error, value:`Airline: ${airline}, Status: ${result}`}]);
            });
        });
        ...
        DOM.elid('fund-airline').addEventListener('click', () => {
            ...
            contract.fundAirline(airline, (error, result) => {
                console.log(error, result);
                display('Airlines', 'Fund Airline', [{label: 'Funding Result', error:error, value: result}]);
            });
        });
        ...
        DOM.elid('fetch-funding-status').addEventListener('click', () => {
            ...
            contract.getAirlineFundingStatus(airline, (error, result) => {
                console.log(error, result);
                display('Airlines', 'Get Status Code', [ { label: 'Funding Status', error: error, value: `Airline: ${airline}, Status: ${result}`}]);
            })
        })
        ...
        DOM.elid('submit-flight').addEventListener('click', () => {
            ...
            contract.fetchFlightStatus(airline, flight, timestamp, (error, result) => {
                display('Oracles', 'Trigger oracles', [ { label: 'Flight Submitted to Oracles', error: error, value: result} ]);
            });
        });
        ...
        DOM.elid('fetch-flight-status').addEventListener('click', () => {
            ...
            contract.getFlightStatus(airline, flight, timestamp, (error, result) => {
                console.log(error, result);
                display('Flight', 'Get Status Code', [ { label: 'Flight Status Code', error: error, value: result}]);
            })
        })
